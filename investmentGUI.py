...
class TextAreaDemo(EasyFrame):
	...
	# Definition of compute() function which is the event handler
	def compute(self):
		"""Computes the investment schedule based on the inputs and outputs to the text area wiidget in tabular format."""
